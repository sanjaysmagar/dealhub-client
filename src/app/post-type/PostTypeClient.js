  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.header}>
        ...
        <p className={styles.subtitle}>Choose the type that best describes your submission</p>
      </div>
      ...
      {TYPES.map((t) => {
          ...
          <>
            ...
            <div className={styles.typeText}>
              <div className={styles.typeTitle}>
                {t.title}
                {!t.enabled && <span className={styles.comingSoonTag}>Coming Soon</span>}
              </div>
        ...
        return t.enabled ? (
          ...
          <div key={t.id} className={`${styles.typeCard} ${styles.typeCardDisabled}`}>
            {CardInner}
          </div>
        );
      })}
