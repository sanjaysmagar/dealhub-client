...
import {
  ChevronRight, Flame, Snowflake, Heart, Share2, Bookmark,
  Link2, Copy, Check, Package, CheckCircle, ShoppingBag,
  ExternalLink, Percent, MousePointer, Award, Star, User,
  Tag, Lock, TrendingUp
} from 'lucide-react';
...
export default function DetailClient({ dealId }) {
  ...
  const score = baseScore + (userVote === 'up' ? 1 : userVote === 'down' ? -1 : 0);
        ...
        <div className={styles.grid}>
          ...
          <div>
            ...
            <div className={styles.voteCard}>
              ...
              <div className={styles.voteRow}>
                ...
                <div className={styles.voteScore}>
                  <span className={styles.voteScoreValue} style={{ color: hc }}>{score}</span>
            ...
            <div className={styles.shareRow}>
              ...
              <button className={styles.shareBtn} onClick={() => setIsSaved(!isSaved)}>
          ...
          <div>
            ...
            <p className={styles.description}>
              {deal.description || 'No additional description provided for this deal.'}
              {' '}Posted {timeAgo(deal.createdAt)} by @{deal.postedBy?.username || 'a member'}.
            </p>

            {/* Price block */}
            <div className={styles.priceBlock}>
              <div>
                <div className={styles.priceWas}>Was {formatPrice(deal.originalPrice)}</div>
                <div className={styles.priceNow}>{formatPrice(deal.discountedPrice)}</div>
            ...
            <div className={styles.lockedWrap}>
              <div className={`${styles.affiliateBox} ${!user ? styles.lockedContent : ''}`}>
                <div className={styles.affiliateTitle}>
                  <Link2 size={16} strokeWidth={2.5} />
                  Your Affiliate Link
                </div>
                <p className={styles.affiliateDesc}>
                  Earn <strong>1 pt per click</strong> and <strong>20 pts per purchase</strong> when
                  someone shops through your link.
                </p>

                <div className={styles.affiliateStats}>
                  <div className={styles.statBox}>
                    <MousePointer size={16} color="#111" strokeWidth={2} style={{ margin: '0 auto' }} />
                    <div className={styles.statValue}>1 pt</div>
                    <div className={styles.statLabel}>Per Click</div>
                  </div>
                  <div className={styles.statBox}>
                    <Award size={16} color="#16a34a" strokeWidth={2} style={{ margin: '0 auto' }} />
                    <div className={styles.statValue} style={{ color: '#16a34a' }}>20 pts</div>
                    <div className={styles.statLabel}>Per Purchase</div>
                  </div>
                  <div className={styles.statBox}>
                    <Star size={16} color="#d97706" strokeWidth={2} style={{ margin: '0 auto' }} />
                ...
                {isGeneratingThisLink && (
                  <div>
                    ...
                    <div className={styles.shimmerLabel}>Creating your unique tracking link...</div>
                  </div>
                )}
